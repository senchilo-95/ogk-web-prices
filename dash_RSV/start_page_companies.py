...
modal_ogk = html.Div(
    [
        dbc.Button(dbc.CardImg(src="/static/dash_RSV/images/ogk.png"),
                   id="open-ogk",
...
modal_tgk = html.Div(
    [
        dbc.Button(dbc.CardImg(src="/static/dash_RSV/images/tgk.png"),
                   id="open-tgk",
                   style={'background-color': bg_modal_color,
                          'font-size': '12pt',
                          'margin': '0px', 'width': '200px','border-radius':'20px'}
...
modal_mos = html.Div(
    [
        dbc.Button(dbc.CardImg(src="/static/dash_RSV/images/mos.png"),
                   id="open-mos",
                   style={'background-color':bg_modal_color,
                          'font-size':'12pt',
                            'margin':'0px','width':'200px','border-radius':'20px'}),
    ...
    ],style={"margin": '0px','textAlign': 'top','margin':'0px'}
                )
